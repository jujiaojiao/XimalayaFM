package com.example.administrator.ximalayafm.download;
...
//                XmPlayerManager.getInstance(DownloadTrackActivity.this).playList(tracks , position);
    ...
    private RankTrackList rankTrackList;

    private void loadData() {
        Map<String ,String> map = new HashMap<>();
        map.put("page" ,++mPageId + "");
        map.put("rank_key" ,"1_57_ranking:track:scoreByTime:1:0");
        ...
        CommonRequest.getRankTrackList(map, new IDataCallBack<RankTrackList>() {
            ...
            public void onSuccess(RankTrackList rankTrackList) {
                ...
                tracks.addAll(rankTrackList.getTrackList());
