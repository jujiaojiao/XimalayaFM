...
public class XMAuthDemoActivity extends Activity {
     ...
     */
    public static final String REDIRECT_URL =  "http://pandahomeapitest.ifjing.com/account/ximalaya_token";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            mAuthInfo = new XmlyAuthInfo(this, CommonRequest.getInstanse().getAppKey() , CommonRequest.getInstanse().getPackId(), REDIRECT_URL, state);
            ...
            if (mAccessToken.isSessionValid()) {
                ...
                if(!isThirdType) {
                    ...
                    AccessTokenManager.getInstanse().setAccessTokenAndUidByThirdType(mAccessToken.getToken(),
                            mAccessToken.getExpiresAt(), "alibaba123", "afdsfasdweew22");
                }
                        ...
                        QrcodeLoginUtil.checkQRCodeLoginStatus(new HashMap<String, String>() {
                            ...
                            public void onSuccess(XmlyAuth2AccessToken object) {
                                if(object!= null) {
                                     ...
                                     * 结果返回之后将取回的结果设置到token管理器中
                                     */
                                    AccessTokenManager.getInstanse().setAccessTokenAndUid(object.getToken() ,object.getExpiresAt(),object.getUid());
